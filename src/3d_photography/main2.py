...
import time
import sys
from mesh2 import write_ply, read_ply, output_3d_photo
...
parser.add_argument('--num', type=int, default='argument.yml',help='Configure of post processing')
...
for idx in tqdm(range(len(sample_list))):
    ...
    print(border)
    print(hFov, vFov)
    print(down / 2 / hFov, right / 2 / vFov)
    #import sys
    #sys.exit(1)
    output_3d_photo(num, verts.copy(), colors.copy(), faces.copy(), copy.deepcopy(Height), copy.deepcopy(Width), copy.deepcopy(hFov), copy.deepcopy(vFov),
