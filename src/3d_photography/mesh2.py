...
def output_3d_photo(idx, verts, colors, faces, Height, Width, hFov, vFov, tgt_poses, video_traj_types, ref_pose,
    ...
    print('int_mtx_x = ', int_mtx_real_x)
    print('int_mtx_y = ', int_mtx_real_y)
    ...
    for video_pose, video_traj_type in zip(videos_poses, video_traj_types):
        #print('video = ', video_pose, video_traj_type)
        stereos = []
        ...
        for tp_id, tp in enumerate(video_pose):
            ...
            if count + 1 == idx:
                if idx < 10:
                    cv2.imwrite('demo/img00{}.jpg'.format(idx), img[..., :3])
                    print(idx, img.shape)
                elif idx >= 100:
                    cv2.imwrite('demo/img{}.jpg'.format(idx), img[..., :3])
                    print(idx, img.shape)
                else:
